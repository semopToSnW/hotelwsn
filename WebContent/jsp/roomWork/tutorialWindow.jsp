...
<div id="roomDetailInfoDiv" >
	<table id="defaultWindow" style='width:100%; height:100%;'>
		<tr>
			<td style="width:100%; height:80%; text-align:center;">
				<img id="logo" style="width:70%;height:auto;"src="<s:url value='/image/LOGO.png' />">
			</td>
		</tr>
		<tr>
			<td style="width:100%; height:20%; text-align:center;">
				<input type="button" value='닫기' style='font-size:30px;' onclick='closeTutorial()'/>
			</td>
		</tr>
	</table>
