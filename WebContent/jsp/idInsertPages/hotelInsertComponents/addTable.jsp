...
function goSearchForm(){
	window.open("/Hotel/member/showSearchForm?type=HC", "검색", "width=500, height=300");
}
</script>
</head>
<body>
<table id="menuTable" >
	...
	<tr>
		<td>등급</td>
		<td>
		<select id="level" name="user.level" disabled="disabled" >
			<option value="HM">관리자</option>
			<option value="HS">직원</option>
		</select>
		</td>
	</tr>
	<tr>
