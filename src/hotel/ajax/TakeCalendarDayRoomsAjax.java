...
public class TakeCalendarDayRoomsAjax extends ActionSupport {
	
	private Logger log = Logger.getLogger(TakeCalendarDayRoomsAjax.class);
	...
	public String takeCalendarDayRooms() throws Exception{
		log.info(roomList);
